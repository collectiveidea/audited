...
@DEPRECATION WARNING: reorder is deprecated. Please use except(:order).order(...) instead. (called from <class:Audit> at /Users/kenneth/Code/FOSS/audited/lib/audited/audit.rb:26)@
...
Join "the mailing list":http://groups.google.com/group/audited for getting help or offering suggestions.
