      ...
      module ClassMethods
        ...
        def audit(*models)
          ...
          models.each do |(model, model_options)|
            ...
            model_observers = model.instance_eval('@observer_peers')
            model.add_observer(AuditSweeper.instance) unless  model_observers && model_observers.include?(AuditSweeper.instance)            
          end
