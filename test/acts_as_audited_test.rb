  ...
  module Acts
    class AuditedTest < Test::Unit::TestCase
      ...
      context "on create" do
        should 'change Audit.count by 1' do
          previous_count = Audit.count
          @user = create_user :audit_comment => "Create"
          Audit.count.should == previous_count + 1
        end
      end
      ...
      context "callbacks" do
        class UserWithCallback < ActiveRecord::Base
          set_table_name :users
          acts_as_audited
          attr_accessor :bogus_attr
          after_audit :do_something
        ...
        should "invoke callback on create" do
          user = UserWithCallback.new
