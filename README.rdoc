...
This fork was created to merge the associated audits feature from http://github.com/celect/acts_as_audited into the primary Rails 3 branch
at http://github.com/collectiveidea/acts_as_audited.
